...
/*----------------------------------------------------------------------+
|									|
|   $Workfile: MyElementGraphicsProcessor.h $
|   $Revision: 1 $
|   	$Date: 3/06/17 11:58a $
|									|
+----------------------------------------------------------------------*/
...
=================================================================================*/
    ...
    virtual bool            _ProduceBodies (bool isCurved, int kernelType) const  override{return false;};//kernelType == KERNEL_TYPE_PSOLID;};
