...
Table CT_MAIN =
{ 
    { 1, CT_ACTION, VIEWING, REQ,	"SHEETAUTOMATION" }, 
}

Table CT_ACTION =
{ 
    { 1, CT_ACTYPE,       INHERIT,	NONE,      "CREATE" },
    { 2, CT_NONE,         INHERIT,  NONE,      "LOGIN"},
}

Table CT_ACTYPE =
{ 
    { 1, CT_NONE,       INHERIT,	NONE,      "SHEET" },
    { 2, CT_NONE,       INHERIT,    NONE,      "MODEL"}
}
